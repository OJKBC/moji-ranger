...
const PHRASES = {
  ...
  // ㊸ あいぼう
  'あいぼうにするね': 'あいぼうに、するね！',
  // 難易度えらび（StageMap のモーダル・さいしょから/つづきから）
  'さいしょから': 'さいしょから？',
  'つづきから': 'つづきから？',
  // かぞえて モンスター（CountMonster）。数字は既存クリップ、フレーズはここで生成。
  'あつめよう': 'あつめよう！',
  'にがそう': 'にがそう！',
  // 出題文を数字込みで読み上げるための部品（「◯こ いるね。もう ◯こ あつめよう」等）
  'こあつめよう': 'こ、あつめよう！',
  'こいるね': 'こ、いるね。',
  'こにがそう': 'こ、にがそう！',
  'もう': 'もう、',
  ...
  'ぜんぶでなんこ': 'ぜんぶで、なんこ？',
  'のこりはなんこ': 'のこりは、なんこ？',
  'あとなんこでじゅう': 'あと、なんこで、じゅう？',
  'せいかい': 'せいかい！',
  'もういちどかぞえてね': 'もういちど、かぞえてね',
  'よくできました': 'よくできました！',
}
