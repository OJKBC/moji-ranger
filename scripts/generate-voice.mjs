...
const MONSTER_NAMES = [
  ...
  'いなずまりゅう', 'ばくえんじゅう', 'こおりゆうき', 'かぜのりゅう', 'いわおうじゃ',
  'きばまじん', 'よるのきし', 'ひかりどり', 'うずしおりゅう', 'だいちのぬし',
  'すなあらし', 'かみなりぞう', 'ほむらまどう', 'みずのひめ', 'もりのおうじゃ',
  'つるぎりゅう', 'くろがねへい', 'あおほのお', 'ぎんのつばさ', 'おおまじん',
  'せいざりゅう', 'やまびこおう', 'にじのじゅう',
]
