...
export const SPELL_WORDS: Record<DifficultyLevel, SpellSpec[]> = {
  ...
  2: [
    ...
    { word: 'wolf', wrong: ['wulf', 'wof', 'wolff', 'wilf'] },
  ],
  3: [
    ...
    { word: 'snake', wrong: ['snak', 'sneak', 'snayk', 'snacke'] },
  ],
  4: [
    ...
    { word: 'turtle', wrong: ['turtel', 'turtl', 'tirtle', 'turttle', 'turdle'] },
    { word: 'carrot', wrong: ['carot', 'carrt', 'carrott', 'karrot', 'carret'] },
    { word: 'cherry', wrong: ['chery', 'cherri', 'cerry', 'cherrry', 'chherry'] },
    { word: 'donkey', wrong: ['donky', 'donkei', 'dankey', 'donnkey', 'donkky'] },
    { word: 'jacket', wrong: ['jaket', 'jackt', 'jackett', 'jackit', 'jecket'] },
    { word: 'button', wrong: ['buton', 'buttn', 'buttun', 'buttonn', 'botton'] },
  ],
  5: [
    ...
    { word: 'monster', wrong: ['moster', 'monstr', 'monstar', 'monnster', 'monsterr'] },
    { word: 'cartoon', wrong: ['carton', 'carton', 'cartooon', 'kartoon', 'cartuun'] },
    { word: 'pancake', wrong: ['pancak', 'pankake', 'pancacke', 'panncake', 'pancaek'] },
    { word: 'hamster', wrong: ['hamstr', 'hampster', 'hamstar', 'hamsterr', 'hemster'] },
    { word: 'pyramid', wrong: ['piramid', 'pyramd', 'pyremid', 'pyrammid', 'pyramiid'] },
    { word: 'peacock', wrong: ['peacok', 'peackock', 'peecock', 'peacokk', 'pecock'] },
  ],
  6: [
    ...
    { word: 'mushroom', wrong: ['mushrom', 'mashroom', 'mushrooom', 'musroom', 'mushrum'] },
    { word: 'snowball', wrong: ['snoball', 'snowbal', 'snowballl', 'snowbol', 'snoowball'] },
    { word: 'seahorse', wrong: ['seahorce', 'seahors', 'seehorse', 'seahorsse', 'sehorse'] },
    { word: 'sailboat', wrong: ['sailbot', 'saliboat', 'sailboatt', 'saylboat', 'sailbaot'] },
    { word: 'doughnut', wrong: ['donut', 'doughnt', 'dughnut', 'doughnutt', 'dougnut'] },
    { word: 'reindeer', wrong: ['raindeer', 'reinder', 'reindeere', 'riendeer', 'reendeer'] },
    { word: 'baseball', wrong: ['basebal', 'baesball', 'baseballl', 'basball', 'basebol'] },
    { word: 'campfire', wrong: ['canpfire', 'campfir', 'campfyre', 'camfire', 'campfirre'] },
  ],
  7: [
    ...
    { word: 'jellyfish', wrong: ['jelyfish', 'jellyfsh', 'jellifish', 'jellyfishh', 'jelllyfish'] },
    { word: 'submarine', wrong: ['submarin', 'submareen', 'submarene', 'submmarine', 'submarinne'] },
    { word: 'waterfall', wrong: ['waterfal', 'watrfall', 'waterfoll', 'waterfalll', 'watterfall'] },
    { word: 'snowflake', wrong: ['snoflake', 'snowflak', 'snowflayke', 'snowfalke', 'snowflke'] },
    { word: 'dinosaurs', wrong: ['dinosors', 'dinasaurs', 'dinosaures', 'dynosaurs', 'dinosaurss'] },
    { word: 'alligator', wrong: ['aligator', 'alligater', 'alligatr', 'aligater', 'allligator'] },
    { word: 'saxophone', wrong: ['saxaphone', 'saxophon', 'saxophoen', 'saxxophone', 'saxofone'] },
    { word: 'cardboard', wrong: ['cardbord', 'cadboard', 'cardbaord', 'carboard', 'cardboarrd'] },
  ],
}
