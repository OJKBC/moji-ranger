...
export const MONSTER_NAMES: Record<string, string> = {
  ...
  // --- 2026-07-11 追加分（つよい 106〜128） ---
  'monster-strong-106': 'いなずまりゅう',
  'monster-strong-107': 'ばくえんじゅう',
  'monster-strong-108': 'こおりゆうき',
  'monster-strong-109': 'かぜのりゅう',
  'monster-strong-110': 'いわおうじゃ',
  'monster-strong-111': 'きばまじん',
  'monster-strong-112': 'よるのきし',
  'monster-strong-113': 'ひかりどり',
  'monster-strong-114': 'うずしおりゅう',
  'monster-strong-115': 'だいちのぬし',
  'monster-strong-116': 'すなあらし',
  'monster-strong-117': 'かみなりぞう',
  'monster-strong-118': 'ほむらまどう',
  'monster-strong-119': 'みずのひめ',
  'monster-strong-120': 'もりのおうじゃ',
  'monster-strong-121': 'つるぎりゅう',
  'monster-strong-122': 'くろがねへい',
  'monster-strong-123': 'あおほのお',
  'monster-strong-124': 'ぎんのつばさ',
  'monster-strong-125': 'おおまじん',
  'monster-strong-126': 'せいざりゅう',
  'monster-strong-127': 'やまびこおう',
  'monster-strong-128': 'にじのじゅう',
